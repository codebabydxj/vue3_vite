      ...
      <el-scrollbar>
        ...
        <div class="letter">
          ...
          <div style="margin: 4px 0;" class="colors">
            ...
            <div style="text-indent: 8em; color: #E6A23C; font-weight: bold;">/ 这里就是你需要写的dom啦 /</div>
        ...
        <div class="letter"> 
          ...
          <div style="margin: 4px 0;" class="colors">使用 keep-alive组件 缓存页面</div>
        </div>
        <div class="letter"> 
        ...
        <div class="letter">
          ...
          <div style="margin: 4px 0;" class="colors">
            <div style="margin: 8px 0">重点强调常用Global方法：&lt;<span style="color: #E6A23C; font-weight: bold;">const globalRouter: any = inject('globalRouter')</span>&gt;，通过inject获取挂载在全局的globalRouter方法</div>
            <div style="margin: 8px 0">(1). 打开一级页面 <span style="color: #E6A23C; font-weight: bold;">globalRouter.openView('/a')</span></div>
            <div style="margin: 8px 0">(2). 打开二级页面 <span style="color: #E6A23C; font-weight: bold;">globalRouter.openView('/a/b')</span></div>
            <div style="margin: 8px 0">(3). 返回上级页面 <span style="color: #E6A23C; font-weight: bold;">globalRouter.goView()</span></div>
            <div style="margin: 8px 0">(4). 关闭当前页面 <span style="color: #E6A23C; font-weight: bold;">globalRouter.closeView()</span></div>
            <div style="margin: 8px 0">(5). 列表按钮重置 <span style="color: #E6A23C; font-weight: bold;">globalRouter.refreshView()</span></div>
          </div>
        </div>
      </el-scrollbar>
    </div>
...
.contain::before {
  ...
  right: 0;
  bottom: 0;
  background: url('../../assets/imgs/bg.jpg') 50% 50% / cover; /* 背景图片路径 */
  opacity: 0.9; /* 设置透明度 */
  z-index: -1; /* 确保背景在内容下方 */
  margin: -20px;
}
