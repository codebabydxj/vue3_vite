<template>
  <div class="login-layout">
    <div class="login-config">
      <el-space :size="15">
        <el-checkbox v-model="themeConfig.glassLogin" @change="changeGlassLogin"><el-text :type="themeConfig.glassLogin ? 'primary' : 'warning'">液态玻璃</el-text></el-checkbox>
        <SwitchDark :fromToLogin="true" @emitSwitch="emitSwitch" />
      </el-space>
    </div>
    <GlassForm v-show="themeConfig.glassLogin"/>
    <div v-show="!themeConfig.glassLogin" class="login-container flx-center" :class="{ 'login-bg-new': themeConfig.isReplaceNewLoginPage, 'login-bg': !themeConfig.isReplaceNewLoginPage }">
...
const changeGlassLogin = (val: any) => {
  myStore.setThemeConfig({ ...themeConfig.value, glassLogin: val });
};
