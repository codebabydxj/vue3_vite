            ...
            <div class="img-box">
              ...
              <el-descriptions title="配置项 📚" :column="1" border>
                ...
                <el-descriptions-item label="request">
                  上传图片的 api 参数 ， 包含url和method（非必传），没传默认走统一上传接口
                </el-descriptions-item>
              ...
              <div class="form-box">
                <div class="form-item">
                  <el-alert
                    ...
                    class="mb20"
                  />
                  <el-form ref="ruleFormRef" label-width="100px" label-suffix=" :" :rules="rules" :model="paramsForm">
                    <el-form-item label="用户头像" prop="avatar">
                      <UploadImg v-model:image-url="paramsForm.avatar" width="135px" height="135px" :file-size="3">
                        <template #empty>
                          <el-icon><Avatar /></el-icon>
                          <span>请上传头像</span>
                        </template>
                    ...
                    <el-form-item label="用户照片" prop="photo">
                      <UploadImgs v-model:file-list="paramsForm.photo" :limit="3" height="140px" width="140px" border-radius="50%">
                        <template #empty>
                          <el-icon><Picture /></el-icon>
                          <span>请上传照片</span>
                        </template>
                    ...
                    <el-form-item label="用户姓名" prop="username">
                      <el-input v-model="paramsForm.username" placeholder="请填写用户姓名" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="身份证号" prop="idCard">
                      <el-input v-model="paramsForm.idCard" placeholder="请填写身份证号" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="邮箱" prop="email">
                      <el-input v-model="paramsForm.email" placeholder="请填写邮箱" clearable></el-input>
                    </el-form-item>
                    <el-form-item>
                ...
                <div class="form-item">
                  <el-alert
                    ...
                    class="mb20"
                  />
                  <el-form label-width="100px" label-suffix=" :" disabled :model="paramsForm1">
                    <el-form-item label="用户头像" prop="avatar">
                      <UploadImg v-model:image-url="paramsForm1.avatar" width="135px" height="135px" :file-size="3">
                        <template #empty>
                          <el-icon><Avatar /></el-icon>
                          <span>请上传头像</span>
                        </template>
                    ...
                    <el-form-item label="用户照片" prop="photo">
                      <UploadImgs v-model:file-list="paramsForm1.photo" height="140px" width="140px" border-radius="50%">
                        <template #empty>
                          <el-icon><Picture /></el-icon>
                          <span>请上传照片</span>
                        </template>
                    ...
                    <el-form-item label="用户姓名" prop="username">
                      <el-input v-model="paramsForm1.username" placeholder="请填写用户姓名" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="身份证号" prop="idCard">
                      <el-input v-model="paramsForm1.idCard" placeholder="请填写身份证号" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="邮箱" prop="email">
                      <el-input v-model="paramsForm1.email" placeholder="请填写邮箱" clearable></el-input>
                    </el-form-item>
                    <el-form-item>
                      <el-button> 取消 </el-button>
                      <el-button type="primary" @click="submit">确定</el-button>
...
import UploadImgs from "@/components/uploadImg/imgs.vue";
